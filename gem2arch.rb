...
def gen_pkgbuild(gem_path)
  ...
  # TODO: iterate over deps and check that their version requirements match versions in pac + AUR
  # TODO: add native depepndencies to depends
...
if $0 == __FILE__
  ...
  IO.write(pkg_name + '/PKGBUILD', gen_pkgbuild(gem_path))
end
